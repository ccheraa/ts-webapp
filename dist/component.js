...
var Tool = (function () {
    ...
    Tool.init = function (args) {
        if (args.length) {
            ...
            vars.dir = tools_1.tpl('{dir}/{name}', vars);
            vars.ts = tools_1.tpl('{dir}/{name}.component.ts', vars);
            vars.html = tools_1.tpl('{dir}/{name}.component.html', vars);
            vars.scss = tools_1.tpl('{dir}/{name}.component.scss', vars);
